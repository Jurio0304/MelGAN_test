...
def parse_args():
    ...
    parser.add_argument("--save_path", default='reco_generate_result')
    parser.add_argument("--load_path", default='test_result')
    parser.add_argument("--reco_wavs_path", default='paper7_reco_wavs')
...
def main():
    ...
    reco_wavs_root = Path(args.reco_wavs_path) if args.reco_wavs_path else None
    ...
    if os.listdir(reco_wavs_root):
        ...
        with torch.no_grad():
            for i, (voc, _) in enumerate(zip(test_voc, test_audio)):
                ...
                save_sample(root / ("reco_generated_%d.wav" % i), 22050, pred_audio)
                print("reco_generated_%d.wav stored" % i)
