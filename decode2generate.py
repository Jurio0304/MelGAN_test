...
def parse_args():
    ...
    parser.add_argument("--save_path", default='decode2generate_result')
    parser.add_argument("--load_path", default='test_result')
    parser.add_argument("--paper7_decode_wavs_path", default='paper7_decode_wavs')
...
def main():
    ...
    paper7_decode_wavs_root = Path(args.paper7_decode_wavs_path) if args.paper7_decode_wavs_path else None
    ...
    if os.listdir(paper7_decode_wavs_root):
        test_set = AudioDataset(
            "decode2generate_test_files.txt",
            # 22050 * 4,
            22050 * 500,
            sampling_rate=22050,
            augment=False,
        ...
        with torch.no_grad():
            for i, (voc, _) in enumerate(zip(test_voc, test_audio)):
                ...
                save_sample(root / ("decode2generated_%d.wav" % i), 22050, pred_audio)
                print("decode2generated_%d.wav stored" % i)
